...
<head>
    ...
    <style type="text/css">
        ...
        .pg-progressstyle {
            ...
            background-image: url('<?php echo $imagePath?>animation.gif');
        }
    ...
    <script type="text/javascript">
        function startProgress()
        {
            ...
            iFrame.src = '<?php echo($index_page!=""?$basePath . $index_page . '/test/index/progress/1':$basePath . 'test/index/progress/1')?>';
        }
