...

{
...

	{
		...
		$arrErrorMessage = $this->session->flashdata ( 'array_error_message' );
		$config = & $CFG->config;
		$config ['arrErrorMessage'] = array();
		...
		if (isset ( $arrErrorMessage ) && !empty($arrErrorMessage)) 
		{
			
			$config ['arrErrorMessage'] = $arrErrorMessage;
		}
