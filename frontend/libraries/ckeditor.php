...
class CKEditor
{
	...
	function __construct($basePath = null) {
		...
		$this->config['basePath'] = base_url().'assets/ckeditor/';
		$this->config['filebrowserBrowseUrl'] = base_url(). 'assets/kcfinder/browse.php?type=files';
		$this->config['filebrowserImageBrowseUrl'] = base_url(). 'assets/kcfinder/browse.php?type=images';
		$this->config['filebrowserFlashBrowseUrl'] = base_url(). 'assets/kcfinder/browse.php?type=flash';
		$this->config['filebrowserUploadUrl'] = base_url(). 'assets/kcfinder/upload.php?type=files';
		$this->config['filebrowserImageUploadUrl'] =  base_url(). 'assets/kcfinder/upload.php?type=images';
		$this->config['filebrowserFlashUploadUrl'] = base_url(). 'assets/kcfinder/upload.php?type=flash';
