...
$(document).ready(function() 
        ...
        {
			action: "<?php print $PREDATA['base_url']?>category_album/previewphoto/",
			responseType: "json",
...
<div class="form-add">
<form class="form-horizontal" action="<?php print $PREDATA['base_url'] ?>category_album/save" method="post" enctype="multipart/form-data">
