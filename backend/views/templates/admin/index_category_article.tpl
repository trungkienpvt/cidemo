...
<a href="{$baseUrl}category_article/add/" class="bt_green"><span class="bt_green_lft"></span><strong>Add new item</strong><span class="bt_green_r"></span></a>
...
<form name="adminForm" action="{$baseUrl}category_article/delete" method="post">                    
