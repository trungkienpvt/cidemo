...
$(document).ready(function() 
        ...
        {
			action: "<?php print $PREDATA['base_url']?>category_product/previewphoto/",
			responseType: "json",
...
<div class="form-add">
<form class="form-horizontal" action="<?php print $PREDATA['base_url'] ?>category_product/save" method="post" enctype="multipart/form-data">
