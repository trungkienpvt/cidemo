...
<script type="text/javascript">
        ...
        {
			action: "<?php print $PREDATA['base_url']?>category_article/previewphoto/",
			responseType: "json",
...
<div class="form-add">
<form class="form-horizontal" action="<?php print $PREDATA['base_url'] ?>category_article/save" method="post" enctype="multipart/form-data">
    ...
    <input type="hidden" name="orderParent" value="<?php print (isset($category_data['parents'])?$category_data['parents']:"")?>"/>
