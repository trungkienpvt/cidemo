...
<script type="text/javascript">
        ...
        {
			action: "<?php print $PREDATA['base_url']?>banner/previewphoto/",
			responseType: "json",
...
<div class="form-add">
<form class="form-horizontal" action="<?php print $PREDATA['base_url']?>banner/save" method="post" enctype="multipart/form-data">
