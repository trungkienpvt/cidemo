...
<div class="">
<a href="<?php print $PREDATA['base_url']?>album/add" class="bt_green"><span class="bt_green_lft"></span><strong><?php print $this->lang->line("ADD NEW ITEM")?></strong><span class="bt_green_r"></span></a> |
...
<form class="form-inline" action="<?php print $PREDATA['base_url']?>album/" method="post" name="frmsearch">
...
<form name="adminForm" id="adminForm" action="<?php print $PREDATA['base_url']?>album/delete" method="post">                    
<table class="table table-striped">
    	...
    	<tr>
            ...
            <?php 
	            if(isset($arrOrder['title']) && $arrOrder['title']=='asc')
	            	echo '<a class="order" href="'.$PREDATA['base_url'] .'album/?order_name=title&order_value=desc'.'" title="asc" ><i class="icon-chevron-up"></i>' . $this->lang->line("TITLE") . '</a>';
	            elseif(isset($arrOrder['title']) && $arrOrder['title']=='desc')
	            	echo '<a class="order" href="'.$PREDATA['base_url'] .'album/?order_name=title&order_value=asc'.'" title="desc" ><i class="icon-chevron-down"></i>' . $this->lang->line("TITLE") . '</a>';
	            else 
            ...
            <?php 
	            if(isset($arrOrder['link']) && $arrOrder['link']=='asc')
	            	echo '<a class="order" href="'.$PREDATA['base_url'] .'album/?order_name=description&order_value=desc'.'" title="asc" ><i class="icon-chevron-up"></i>' . $this->lang->line("LINK") . '</a>';
	            elseif(isset($arrOrder['link']) && $arrOrder['link']=='desc')
	            	echo '<a class="order" href="'.$PREDATA['base_url'] .'album/?order_name=description&order_value=asc'.'" title="desc" ><i class="icon-chevron-down"></i>' . $this->lang->line("LINK") . '</a>';
	            else 
            ...
            <?php 
	            if(isset($arrOrder['ordering']) && $arrOrder['ordering']=='asc')
	            	echo '<a class="order" href="'.$PREDATA['base_url'] .'album/?order_name=ordering&order_value=desc'.'" title="asc" ><i class="icon-chevron-up"></i>' . $this->lang->line("ORDERING") . '</a>';
	            elseif(isset($arrOrder['ordering']) && $arrOrder['ordering']=='desc')
	            	echo '<a class="order" href="'.$PREDATA['base_url'] .'album/?order_name=ordering&order_value=asc'.'" title="desc" ><i class="icon-chevron-down"></i>' . $this->lang->line("ORDERING") . '</a>';
	            else 
            ...
            <?php 
	            if(isset($arrOrder['category']) && $arrOrder['category']=='asc')
	            	echo '<a class="order" href="'.$PREDATA['base_url'] .'album/?order_name=category&order_value=desc'.'" title="asc" ><i class="icon-chevron-up"></i>' . $this->lang->line("CATEGORY") . '</a>';
	            elseif(isset($arrOrder['category']) && $arrOrder['category']=='desc')
	            	echo '<a class="order" href="'.$PREDATA['base_url'] .'album/?order_name=category&order_value=asc'.'" title="desc" ><i class="icon-chevron-down"></i>' . $this->lang->line("CATEGORY") . '</a>';
	            else 
    ...
    <input type="hidden" name="orderid[]" value="<?php print $item['id']?>"/>
    		...
    		<a href='<?php print $PREDATA['base_url']?>album/add/id/<?php print $item['id']?>/translate/1'><?php print $this->lang->line('TRANSLATE')?></a>
    		<?php endif?>
    		</td>
            <td><a href="<?php print $PREDATA['base_url']?>album/add/id/<?php print $item['id']?>" class=""><img src="<?php print $PREDATA['imagePath']?>edit-icon.png"" alt="" title="" border="0" /></a></td>
            <td><a href="<?php print $PREDATA['base_url']?>album/delete/id/<?php print $item['id']?>" class="deleted"><img src="<?php print $PREDATA['imagePath']?>delete-icon.png"" alt="" title="" border="0" /></a></td>
        </tr>
        <?php 
        $count ++;
        endforeach;?>
     ...
     <input type="hidden" id="action_form" value="<?php print $PREDATA['base_url']?>album/updateorder" name="action_form"/>
 </form>    
